...
const SingleSpotDetails = () => {
  ...
  const avg = () => {
    if (spot.avgStarRating === null) return "new";
    else if (
      typeof spot.avgStarRating === "string" ||
      spot.avgStarRating instanceof String
    )
      return parseFloat(spot.avgStarRating).toFixed(1);
    else return spot.avgStarRating.toFixed(1);
  };
      ...
      >
        <div className="above-spot-image">
          ...
          <div className="before-image">
            ...
            <h4 style={{ fontWeight: "normal", textDecoration: "underline" }}>
              {spot.numReviews} reviews
            </h4>
            <h4 style={{ fontWeight: "normal" }}>
              &middot; Superhost &middot;
            </h4>
          ...
          <div>
            <div className="host">
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                >
                  Entire home hosted by Kia And Rob
                </h2>
              </div>
              <h3
                style={{
              ...
              >
                14 guests &middot; 5 bedrooms &middot; 9 beds &middot; 3.5 baths
              </h3>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                ...
                >
                  <div>
                    <strong>Kia And Rob is a Superhost</strong>
                  </div>
                  <div
                    style={{
                      color: "rgb(120,120,120)",
          ...
          <div className="price-box">
            ...
            <div className="edit-delete-spot-Btns">
              ...
              {sessionUser && sessionUser.id === spot.ownerId && (
                <OpenModalMenuItem
                  itemText={
                    <button className="edit-spot-Btn">Edit your spot</button>
                  }
                  onItemClick={closeMenu}
              ...
              {sessionUser &&
                ...
                !didUserAlreadyReview(reviews, sessionUser.id) && (
                  <OpenModalMenuItem
                    ...
                    onItemClick={closeMenu}
                    modalComponent={
                      <CreateReviewModel key={spotId} spotId={spotId} />
                    }
                  />
                )}
            </div>
